...
__webpack_require__(336).polyfill()
...
/* WEBPACK VAR INJECTION */(function(global) {var now = __webpack_require__(337)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__window_intro__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__window_main__ = __webpack_require__(343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__game__ = __webpack_require__(344);
...
new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
    ...
    methods: {
        ...
        startSingleGame() {
            const game = new __WEBPACK_IMPORTED_MODULE_3__game__["a" /* Game */](this.color);
    ...
    `,
    components: {
        'intro-window': __WEBPACK_IMPORTED_MODULE_1__window_intro__["a" /* default */],
        'main-window': __WEBPACK_IMPORTED_MODULE_2__window_main__["a" /* default */]
    }
});
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(43), __webpack_require__(340).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(43), __webpack_require__(130)))
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__figure__ = __webpack_require__(345);
    ...
    constructor(color) {
                        ...
                        for (let color in data.players) {
                            if (data.players.hasOwnProperty(color)) {
                                ...
                                for (let j = 0; j < figures.length; j++) {
                                    const figure = new __WEBPACK_IMPORTED_MODULE_0__figure__["a" /* Figure */](color, figures[j].class, figures[j].id, figures[j].x, figures[j].y);
                                    figure.render(board);
        ...
        $(document).on('mouseup', () => {
            ...
            cells.each(function () {
                const cell = $(this);
                const pos = cell.position();
                if (centerX >= pos.left && centerX <= pos.left + cell.outerWidth(true) && centerY >= pos.top && centerY <= pos.top + cell.outerHeight(true)) {
                    found = true;
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {class Figure {
